...
def backup(device, ip, successful_backups):
    try:
        ...
        send_sho_run = connection.send_command('sho cdp nei det')
        out_file_name = f"/var/www/shared/BLD-18/terminal_servers_backup_configs/show_cdp_neighbors_detail/sho_cdp_nei_det-{ip}.txt"
